"""Download and verify the currently active V3 release from OSS."""
    ...
    *,
    ...
    try:
        ...
        with open(metadata_path, encoding="utf-8") as handle:
            metadata = validate_opportunity_metadata(
                json.load(handle),
                run_id,
            )
        if (
            ...
            raise ValueError("生产V3预测合同与清单不一致")
