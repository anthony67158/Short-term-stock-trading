...
当前机会特征合同为 `opportunity-score-feature.v6`，共 136 维。V6 在
V5 的五日资金连续性基础上增加平台突破、缩量回踩、量价齐升、长下影修复和
低波动趋势的原始指标与连续强度分。旧 V1-V5 请求在量化服务内按版本投影，
新增字段补零，支持主服务与模型的无中断切换；V6 训练要求至少 95% 样本拥有
完整形态历史，禁止用补零旧样本冒充重建完成。
