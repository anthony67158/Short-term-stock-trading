"""Shared, leak-free dataset preparation for decision-model bakeoffs."""
...
from .datasets import build_opportunity_dataset
...
POC_DATASET_SCHEMA_VERSION = "decision-model-backtest-dataset.v1"
TIME_BUCKETS = (
    "INTRADAY_OPEN",
    "INTRADAY_MORNING",
    "INTRADAY_AFTERNOON",
