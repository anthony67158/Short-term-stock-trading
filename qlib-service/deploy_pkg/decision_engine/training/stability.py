"""Aggregate repeated decision-model bakeoff runs."""
...
SUMMARY_SCHEMA_VERSION = "decision-model-bakeoff-summary.v1"
...
def summarize_reports(paths):
    ...
    for path in paths:
        ...
        if value.get("schemaVersion") != "decision-model-bakeoff.v1":
