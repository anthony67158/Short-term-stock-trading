...
class OpeningLot(Base):
    __tablename__ = "opening_lots"
    __table_args__ = (
        UniqueConstraint("account_id", "command_key", name="uq_opening_command"),
        UniqueConstraint("account_id", "source_key", name="uq_opening_source"),
        UniqueConstraint("account_id", "account_version", name="uq_opening_version"),
        CheckConstraint("quantity_shares > 0 AND quantity_shares <= 1000000000", name="quantity"),
